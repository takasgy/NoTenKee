    ...
    public class NoTenKeeTest_SINGLE1
    {
        ...
        public void TestMethod_Single()
        {
            string[] args = {
                ...
                ConstTest.XML_PATH + "Excel_Report_SINGLE.xml",
                ConstTest.INPUT_PATH + "testData.csv",
                TestUtil.CreateOutputPath(ConstTest.OUTPUT_PATH, "TestMethod_Single") };
        ...
        public void TestMethod_Single_R1()
        {
            string[] args = {
                ConstTest.XML_PATH + "NoTenkee_environment.xml",
                ConstTest.XML_PATH + "Excel_Report_SINGLE_R1.xml",
                ConstTest.INPUT_PATH + "testData.csv",
                TestUtil.CreateOutputPath(ConstTest.OUTPUT_PATH, "TestMethod_Single_R1") };
            NotenKee notenkee = new NotenKee();
            notenkee.Execute(args);
        }
    }
